...
export function CombatUI({ playerHp, playerMaxHp, enemyHp, enemyMaxHp, enemyName, isBoss = false }: CombatUIProps) {
  return (
    <UIContainer>
      {/* Player Panel */}
      <CharacterPanel>
        ...
        <NameLabel>SPIELER</NameLabel>
        <HPContainer>
          <HPBar current={playerHp} max={playerMaxHp} color={theme.colors.hpGreen} />
        </HPContainer>
      </CharacterPanel>
      ...
      <CharacterPanel>
        <Portrait $color={theme.colors.hpRed}>
          <EnemyPortraitIcon isBoss={isBoss} />
        </Portrait>
        <NameLabel>{enemyName}</NameLabel>
        <HPContainer>
          <HPBar current={enemyHp} max={enemyMaxHp} color={theme.colors.hpRed} />
        </HPContainer>
      </CharacterPanel>
    </UIContainer>
  );
