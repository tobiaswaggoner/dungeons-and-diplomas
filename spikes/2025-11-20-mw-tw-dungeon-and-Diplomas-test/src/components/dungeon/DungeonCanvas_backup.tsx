...
export function DungeonCanvas() {  const canvasRef = useRef<HTMLCanvasElement>(null);  // Combat state  const [inCombat, setInCombat] = useState(false);  const [playerHp, setPlayerHp] = useState(PLAYER_MAX_HP);  const currentEnemyRef = useRef<Enemy | null>(null);
